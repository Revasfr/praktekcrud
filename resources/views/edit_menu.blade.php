     ...
     <div class="container mt-4">
        <div class="card">
            <div class="card-header">
                <h5 class="float-start">Edit Daftar Menu</h5>
            </div>
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input name="menu" class="form-control" id="input" value="{{$menu->menu}}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="input" class="col-sm-2 col-form-label">Harga</label>
                        <div class="col-sm-10">
                            <input name="harga" class="form-control" id="input" value="{{$menu->harga}}">
                        </div>
                    </div>
